        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.Img(src='assets/MedCabinet_Logo.png', className='img-fluid', height=100, width=100),
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:ryan@zernach.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Zernach/DataScience'),
